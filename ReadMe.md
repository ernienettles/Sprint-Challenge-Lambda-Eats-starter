...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    Matches the current URL in the same way that <Route> would. Let's you get the match data without actually rendering a <Route>.

2. How would you explain form validation to someone who has never programmed before?

    That form validation is like a wall that doesn't allow the user past until
    they do what the wall is asking.

3. In 1-2 sentences, define end to end testing.

    A testing technique that is used to test whether the flow of an application
